...
view1.layer.add(ArcSpringAnimation(startAngle: 90, withEndAngle: -90, beginTime: 1.5), forKey: "arcPositionAnimationV1")
view2.layer.add(ArcSpringAnimation(startAngle: 90, withEndAngle: -40, beginTime: 1.5), forKey: "arcPositionAnimationV2")
view3.layer.add(ArcSpringAnimation(startAngle: 90, withEndAngle: 10, beginTime: 1.5), forKey: "arcPositionAnimationV3")
view4.layer.add(ArcSpringAnimation(startAngle: 90, withEndAngle: 60, beginTime: 1.5), forKey: "arcPositionAnimationV4")
